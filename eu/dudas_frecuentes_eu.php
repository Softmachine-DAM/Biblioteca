...
<head>
    ...
    <link rel="stylesheet" href="/Styles/Estilos_Dudas_.css">
...
<body> 
    ...
    <main>
        <h2 class=Titulo_Dudas><B>GALDERA OROKORRAK</B></h2>
        <br>
        <img id="Foto_Dudas" src="/Imagenes/foto_biblioteca_muskiz.jpg" alt="Biblioteca Muskiz">
        <div>
            <h3>Zenbat egunetan har dezaket liburu bat maileguan?</h3>
            <p>Liburu bat maileguan har dezakezu 14 eguneko iraupenaz.</p><br>
        </div>
        <div>
            <h3>Zenbat liburu har ditzaket aldi berean?</h3>
            <p>Gehienez 3 mailegu aktibo izan ditzakezu aldi berean.</p><br>
        </div>
        <div>
            <h3>Zigorren bat al dago liburu bat berandu itzultzen badut?</h3>
            <p>Bai, berandu itzultzen bada, kasuan kasuko erabiltzaileak ezingo du beste libururik hartu kopia itzuli gabeko denboraren baliokide den denbora tarte batean.</p><br>
        </div>
        <div>
            <h3>Zein da liburutegiko ordutegia?</h3>
            <p>Astelehenetik ostiralera 10:00etatik 13:00etara eta 16:00etatik 19:45era. Larunbat eta igandeetan liburutegia itxita dago.</p><br>
        </div>
        <div>
            <h3>Haragia behar al da liburutegira sartzeko?</h3>
            <p>Haragia ez da beharrezkoa liburutegira sartzeko, baina maileguak egiteko behar da.</p><br>
        </div>
        <div>
            <h3>Noiz gertatzen dira ekitaldiak?</h3>
            <p>Ekitaldiak ostiraletan izaten dira beti, 18:00etan</p>
        </div>
    </main>

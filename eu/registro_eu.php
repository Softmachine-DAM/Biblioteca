...
<head>
    ...
    <meta name="keywords" content="inicio sesion,libros, biblioteca, Muskiz, lectura" >
...
<body>
    ...
    <main id="sign-in">
        <h1>Erregistro Berria</h1> 
        <form>
            <label for="nombre">Izena</label><br>
            <input type="text" name="nombre" id="nombre"><br>
            <label for="apellidos">Izen-Abizenak</label><br>
            <input type="text" name="apellidos" id="apellidos"><br>
            <label for="correo">Helbide Elektronikoa</Label><br>
            <input type="email" name="correo" id="correo"><br>
            <label for="passwd">Pasahitza</label><br>
            <input type="password" name="passwd" id="passwd"><br><br>
            <input type="button" value="Sartu">
        </form>
        <sub>¿Erregistratua zaude? <a href="/eu/inicio_sesion_eu.html" style="text-decoration-color: blue;">Hasi saioa hemen.</a></sub>
    </main>
